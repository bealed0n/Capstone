...
import { Container, Card, ListGroup, Alert, Spinner, Button, Image, Form } from 'react-bootstrap';
    ...
    <Container className="mt-5">
      <Card>
        ...
        <Card.Body>
          ...
          {/* Publicaciones "Liked" */}
          <h5 className="mt-4">Publicaciones "Liked":</h5>
          ...
          {(profile.role === 'tattoo_artist' || profile.role === 'designer') && (
            <>
              <h5 className="mt-4">Productos Creados:</h5>
          ...
          <h5 className="mt-4">Publicaciones Creadas</h5>
          ...
          {profile.role === 'client' && (
            <>
              <h5 className="mt-4">Horas Agendadas</h5>
          ...
          {(profile.role === 'tattoo_artist' || profile.role === 'designer') && (
            <>
              <h5 className="mt-4">Reservas de Clientes</h5>
